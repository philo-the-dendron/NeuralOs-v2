...
5. [x] MSRV declared and tested on the bumped pin. (PR C, #27: `rust-version` 1.92 checked on 1.92.0 in CI, in the `std`, `no_std` and `simd` configurations; PR L, #37, added the fourth, `unstable-stdp`; round 48 the fifth, `unstable-bridge`.)
