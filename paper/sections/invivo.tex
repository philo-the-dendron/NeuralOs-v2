...
\emph{reads} --- and adapts under --- the shipped model's own activity:
...
arrangement-reading result's only lineage is on that grid, and a
...
\paragraph{Tier 1: the substrate reads arrangement under the model's
own drive.}
Table~\ref{tab:t1gates} gives the gate results. G0 --- firing reads
