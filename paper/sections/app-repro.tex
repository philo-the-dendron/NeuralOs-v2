...
\texttt{0.1.0-alpha.2} on crates.io (\texttt{no\_std} by default;
...
\texttt{llama\_vocab\_n\_tokens}). Built CPU-only (cmake 4.4.2);
...
\item Null families: \texttt{evidence/session-i-primary/}
  (dose $\times$10, value-flip $\times$3) and
  \texttt{evidence/session-i-stress/} ($\approx$2$\times$ arm) ---
