...
stated in-text), the substrate's firing reads the model's weight
arrangement over census (Hamming gap 1.35--1.36$\times$ under the
in-vivo drive, 1.63$\times$ synthetic; one slice, one model, one
seed), and local plasticity rewrites a declared $0.5\%$-of-one-layer
...
arrangement-reading sensitivity, the falsification-driven discovery
