...
\paragraph{p3 --- the generic basin.}\mbox{}\par
\noindent{\footnotesize\setlength{\tabcolsep}{6pt}%
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{118pt}>{\raggedright\arraybackslash}p{322pt}@{}}
\toprule
...
$\langle\backslash$n$\rangle^{\times2}$The following is a \\
...
\medskip
\paragraph{p2 --- the full denominator of the 4/10 dose flips.}\mbox{}\par
\noindent{\footnotesize\setlength{\tabcolsep}{6pt}%
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{118pt}>{\raggedright\arraybackslash}p{322pt}@{}}
\toprule
