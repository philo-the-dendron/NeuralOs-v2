...
\author{%
  philo-the-dendron\thanks{Independent. Code and evidence:
  \url{https://gitea.com/Caramoussin/NeuralOs-v2} (AGPL-3.0);
  software crate \texttt{neuralos-snn} on crates.io.}%
}
\date{Version 1.0, August 2026\quad---\quad Branch B}
...
\input{sections/loop}
\input{sections/invivo}
\input{sections/adjudication}
...
\appendix
\input{sections/app-transcripts}
\input{sections/app-repro}
